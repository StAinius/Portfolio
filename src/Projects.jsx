  ...
  const projects = [
    {
      ...
      images: [
        '/Portfolio/images/web/1.png',
        '/Portfolio/images/web/2.png',
        '/Portfolio/images/web/3.png',
        '/Portfolio/images/web/4.png'
      ],
    ...
    },
    {
      ...
      images: [
        '/Portfolio/images/import/AD.png',
        '/Portfolio/images/import/CSV.png'
      ],
      technologies: ['Python']
    }
  ];
