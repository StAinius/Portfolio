...
const Contact = () => {
  ...
  return (
    <LazySection direction="right">
      <section id="contact">
        <h2 className="section-title" style={{ textAlign: 'left', marginLeft: '0' }}>Kontaktai</h2>
        ...
        <div className="contact-grid-3">
          ...
          <div className="contact-card-item">
            ...
            <div className="contact-content">
              <div className="contact-label">Vardas</div>
              <div className="contact-value">Ainius Stonkus</div>
            </div>
          </div>
          ...
          <div className="contact-card-item">
            ...
            <div className="contact-content">
              ...
              <div className="contact-value">Vilnius, Lietuva</div>
            </div>
          </div>

          {/* Email Card */}
          <div className="contact-card-item contact-clickable" onClick={() => copyToClipboard('stonkusainius@gmail.com')}>
            <div className="contact-icon-wrapper">
              {icons.email}
            </div>
            <div className="contact-content">
              <div className="contact-label">El. paštas</div>
              <div className="contact-value">stonkusainius@gmail.com</div>
            </div>
          </div>

          {/* Phone Card */}
          <div className="contact-card-item contact-clickable" onClick={() => copyToClipboard('+37069554829')}>
            <div className="contact-icon-wrapper">
              {icons.phone}
            </div>
            <div className="contact-content">
              <div className="contact-label">Telefonas</div>
              <div className="contact-value">+37069554829</div>
            </div>
          </div>

          {/* LinkedIn Card */}
          <div className="contact-card-item contact-clickable" onClick={() => window.open('https://www.linkedin.com/in/ainius-stonkus/', '_blank')}>
            <div className="contact-icon-wrapper">
              {icons.linkedin}
            </div>
            <div className="contact-content">
              <div className="contact-label">LinkedIn</div>
              <div className="contact-value contact-link">Profilis</div>
            </div>
          </div>

          {/* GitHub Card */}
          <div className="contact-card-item contact-clickable" onClick={() => window.open('https://github.com/StAinius', '_blank')}>
            <div className="contact-icon-wrapper">
              {icons.github}
            </div>
            <div className="contact-content">
